...
insert into advisor_expected values
  ...
  ('authenticated_security_definer_function_executable', 'brigade.register_session(uuid, text, text, text, text, text, text, text, integer, uuid, text, bigint, text, text)'),
  ('authenticated_security_definer_function_executable', 'brigade.session_heartbeat(uuid, text, text, text, text, integer, text, bigint, text)'),
